...
class ReleaseScreen extends StatelessWidget {
  ReleaseScreen({Key? key}) : super(key: key);
  DashboardProvider _dashboardProvider = sl();
  DateTimeProvider _dateTimeProvider = sl();
  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      builder: (context, child) {
        return ReleaseScreenContent();
      },
    );

    ChangeNotifierProvider.value(value: _dashboardProvider, child: ReleaseScreenContent());
  }
}

class ReleaseScreenContent extends StatelessWidget {
  ReleaseScreenContent({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  controller: context.read<DashboardProvider>().releaseController,
                  ...
                  onTap: () async {
                    ...
                    if (context.read<DateTimeProvider>().releaseDate.value != null) {
                      context.read<DashboardProvider>().releaseController.text = DateFormat('yyyy-MM-dd').format(context.read<DateTimeProvider>().releaseDate.value!);
                    }
                  },
                ),
                SizedBox(
