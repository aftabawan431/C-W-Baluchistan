...
class BarChartSample1State extends State<BarChartSample1> {
  ...
  BarChartGroupData makeGroupData(
    ...
    Color barColor = const Color(0xFF2A9488),
    double width = 22,
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          ...
          width: width,
          borderSide: isTouched ? BorderSide(color: Colors.yellow.darken(), width: 1) : const BorderSide(color: Colors.white, width: 0),
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = const Text('P1', style: style);
        break;
      case 1:
        text = const Text('P2', style: style);
        break;
      case 2:
        text = const Text('P3', style: style);
        break;
      case 3:
        text = const Text('P4', style: style);
        break;
      case 4:
        text = const Text('P5', style: style);
        break;
      case 5:
        text = const Text('P6', style: style);
        break;
      case 6:
        text = const Text('P7', style: style);
        break;
      default:
